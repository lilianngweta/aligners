...
- Open the ```./synthetic-data-generation``` folder and then open either the ```ethical```, ```factuality```, or ```helpful``` folders depending on the type of dataset you are trying to generate.
